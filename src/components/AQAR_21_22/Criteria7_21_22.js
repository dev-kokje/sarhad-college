...
import c7111 from "../../assets/docs/aqar2022/7.1.1.pdf";
import c7112 from "../../assets/docs/aqar2022/7.1.1.2.pdf";
import c719 from "../../assets/docs/aqar2022/7.1.9.pdf";
import c7192 from "../../assets/docs/aqar2022/7.1.9.2.pdf";
import c721 from "../../assets/docs/aqar2022/7.2.1.pdf";
import c7212 from "../../assets/docs/aqar2022/7.2.1.2.pdf";
import c731 from "../../assets/docs/aqar2022/aq22_7.3.1.pdf";

const Criteria7_21_22 = (props) => {
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <a className="btn btn-sm btn-outline-primary my-2" href={ c719 } target="_blank" rel="noreferrer"> View Report 1 </a>
                            <a className="btn btn-sm btn-outline-primary my-2" href={ c7192 } target="_blank" rel="noreferrer"> View Report 2 </a>
                        </td>
                    </tr>
                    <tr>
                        <td>7.1.10.</td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <a className="btn btn-sm btn-outline-primary my-2" href={ c721 } target="_blank" rel="noreferrer"> View Report 1</a>
                            <a className="btn btn-sm btn-outline-primary my-2" href={ c7212 } target="_blank" rel="noreferrer"> View Report 2</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><a className="btn btn-sm btn-outline-primary my-2" href={ c731 } target="_blank" rel="noreferrer"> View Report </a></td>
                    </tr>
                </tbody>
            </Table>
        </Hoc>
...
export default Criteria7_21_22;